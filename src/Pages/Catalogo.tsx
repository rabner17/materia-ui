const Catalogo = () => {
  const productos = [
    { id: 1, nombre: 'Descuentos Insuperables', imagen: './src/img/Catalogo.png' },
    { id: 2, nombre: 'Camiseta', precio: 34.99, imagen: './src/img/01.jpg' },
    { id: 3, nombre: 'Camiseta', precio: 45.99, imagen: './src/img/02.jpg' },
